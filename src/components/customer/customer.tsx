...
const companies = [
  ...
  { name: 'Universal Music Group', logo: 'https://picsum.photos/seed/universal/120/40' },
  { name: 'Metro', logo: 'https://picsum.photos/seed/metro/120/40' },
  { name: 'Imperial College London', logo: 'https://picsum.photos/seed/imperial/120/40' },
...
function Customers() {
  return (
    <section className="max-w-5xl mx-auto px-4 py-16">
      ...
      >
        <motion.h2 variants={itemVariants} className="text-sm uppercase text-gray-500 mb-4">
          Our friends
        </motion.h2>
        <motion.h3 variants={itemVariants} className="text-4xl md:text-5xl font-bold max-w-4xl mx-auto">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 md:gap-12 mb-16"
      >
      ...
      >
        <motion.blockquote variants={itemVariants} className="text-xl md:text-2xl text-gray-700 mb-6">
        ...
        <motion.div variants={itemVariants} className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="text-sm text-gray-500">VP Marketing, Fit For Bucks</div>
          </div>
        </motion.div>
